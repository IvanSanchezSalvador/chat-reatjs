            ...
            <main className={classes.main}>
                ...
                <Paper className={classes.paper}>
                    ...
                    <form onSubmit={(e) => this.submitSignup(e)} className={classes.form}>
                        <FormControl reuired fullWidth margin='normal'>
                    ...
                    </form>
                    {
                        ...
                        <Typography className={classes.errorText} component='h5' variant='h5'>
                            {this.state.signupError}
                        </Typography>:
                        null
                    }
                    <Typography component='h5' variant='h6' className={classes.hasAccontHeader}>Already Have An Account?</Typography>
